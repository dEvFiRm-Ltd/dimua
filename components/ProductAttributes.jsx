...
function ProductAttributes({ text, classes }) {
  return (
    ...
    >
      ...
      />
      <i className='fa-solid fa-check z-20 absolute text-white right-[5px] top-[0.5px] text-[10px] peer-checked:block peer-checked:opacity-[1] '></i>
      ...
      <label
        className=' py-8 px-10 w-full border border-ash rounded-sm capitalize cursor-pointer peer-checked:border-green'
        htmlFor={text}
      >
        {text}
      </label>
