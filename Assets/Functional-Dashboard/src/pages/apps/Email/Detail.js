          ...
          <div className='email-container'>
            ...
            <div className='inbox-rightbar p-4'>
              <ButtonGroup className='mr-1'>
                ...
                <UncontrolledTooltip placement='top' target='spam'>
                  Mark as spam
                </UncontrolledTooltip>
              ...
              <UncontrolledTooltip placement='top' target='move-folder'>
                Folder
              </UncontrolledTooltip>
              ...
              <UncontrolledTooltip placement='top' target='mark-label'>
                Labels
              </UncontrolledTooltip>
              ...
              <UncontrolledTooltip placement='top' target='more-actions'>
                More Actions
              </UncontrolledTooltip>
              ...
              <div className='mt-3'>
                ...
                <Media className='mb-4 mt-1'>
                  <img
                    className='d-flex mr-2 rounded-circle avatar-sm'
                    src={email.avatar}
                    alt={email.from_name}
                  />
                  <Media body>
                    <span className='float-right'>{email.recieved_on}</span>
                ...
                <h6>
                  <i className='uil uil-paperclip mb-2'></i> Attachments{' '}
                  <span>(3)</span>
                </h6>
                        ...
                        <Card className='p-2 border rounded mb-2'>
                          <Media>
                            ...
                            <Media body>
                              <a
                                href='/'
                                className='d-inline-block mt-2 text-muted font-weight-bold'
                              >
                                {f.name}
                              </a>
                            </Media>
