      ...
      <div className='flex flex-col w-[65%] '>
        <div className='mb-20'>
          <h5 className='font-normal'>
            The velvet fabric is quite ok, it's not thick, it's not that thin,
            the color is pretty, the pants are over the ankle (about 90cm) there
            is a little mistake but I reported it to the shop and the only point
            is that the pants are quite big and the pants are high waisted. The
            shop also gives me a gift card and a thank you letter...
          </h5>
          <button
            type='button'
