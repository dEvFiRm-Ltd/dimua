...
function FlashItem({ content, classes }) {
  return (
    <Link
      to={`/${content.slug}`}
      className={`bg-white rounded-lg block w-[229px] ${classes}`}
    >
      <div className='rounded-lg p-16 w-full h-[229px] flex justify-center items-center '>
