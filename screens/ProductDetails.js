...
const ProductDetails = ({ navigation }) => {
  ...
  return (
    <ScrollView 
    // style={productDetails.contianer}
    >
      <View 
      // style={productDetails.header}
      >
      ...
      <View style={{ marginBottom: 13 }}>
        <Text 
        // style={productDetails.price}
        >$150</Text>
      </View>
      <View>
        <View style={{ marginVertical: 14.5 }}>
          <Text 
          // style={productDetails.textHeader}
          >delivery info</Text>
          <Text 
          // style={productDetails.textDetails}
          >
